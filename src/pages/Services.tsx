    ...
    <MainLayout>
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Catálogo de servicios y estructura de comisiones</p>
        </div>
              ...
              <div className="space-y-2 pt-4 border-t border-border">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-accent tabular-nums">
                    ...
                    {service.commission_type === 'variable' && <span className="text-xs text-muted-foreground ml-1">(variable)</span>}
                  </span>
                </div>
              </div>
              <div className="mt-4">
